import 'package:avauserapp/components/likeButton/like_button.dart';
...
class LikeButtonState extends State<LikeButton> with TickerProviderStateMixin {
  ...
  void onTap() {
    ...
    if (widget.onTap != null) {
      widget.onTap(_isLiked, position).then((bool isLiked) {
