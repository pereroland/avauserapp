...
class OverlaySupportEntry {
  ...
  static OverlaySupportEntry? of(BuildContext context,
      {required Widget requireForDebug}) {
...
class _OverlaySupportEntryEmpty implements OverlaySupportEntry {
  ...
  @override
  Completer get _dismissedCompleter => Completer();

  @override
  OverlayEntry get _entry => OverlayEntry(builder: (sa) {
        return Container();
      });

  @override
  _OverlayKey get _key => _OverlayKey(Key("ecity"));

  @override
  GlobalKey<_AnimatedOverlayState> get _stateKey =>
      GlobalKey<_AnimatedOverlayState>();
